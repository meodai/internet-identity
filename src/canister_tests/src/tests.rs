...
/// Tests related to local device management (add, remove, lookup, anchor_info).
...
mod device_management_tests {
    ...
    /// This test should fail, see L2-745.
    #[test]
    ...
    /// Verifies that anchor_info requires authentication.
    #[test]
